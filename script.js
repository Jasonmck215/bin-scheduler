document.addEventListener('DOMContentLoaded', function () {
    ...
    generateButton.addEventListener('click', function () {
        ...
        const collectionDatesJson = generateCollectionDatesJson();
        console.log(JSON.stringify(collectionDatesJson, null, 2)); // Output the JSON to the console
    });
    ...
    function generateCollectionDatesJson() {
        const allDates = [];
