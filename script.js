document.addEventListener('DOMContentLoaded', function () {
    ...
    generateButton.addEventListener('click', function () {
        ...
        sendCollectionData(collectionDates);
    });
    ...
    function sendCollectionData(data) {
        fetch('https://your-server-endpoint.com/update-bin', {
            method: 'POST',
            headers: {
        ...
        .then(result => {
            if (result.success) {
                showPopupMessage('Successfully updated your BIN');
            } else {
                showPopupMessage('Failed to update your BIN');
            }
        })
        .catch(error => {
            showPopupMessage('Failed to update your BIN');
